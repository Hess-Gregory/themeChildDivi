...
<div class="et-tab-content ui-tabs-panel ui-widget-content ui-corner-bottom">
	<div class="et-epanel-box et-epanel-box__checkbox-list" >
		<div class="et-box-title">
        	<h2 style="line-height:25px;"><?php _e( dct_themename .' Child Theme', 'dctonepage' ); ?> <?php _e( dct_themedesc .' Child Theme', 'dctonepage' ); ?></h2>
    ...
    <div class="et-epanel-box" style="margin:50px 50px 50px 0px ;" >
    	<div class="info-box">
