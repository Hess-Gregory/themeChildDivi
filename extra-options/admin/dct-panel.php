	...
	<div id="panel-wrap" >  
        ...
        <ul id="epanel-mainmenu" class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" >			
        	...
        	<li class="ui-state-default ui-corner-top <?php echo $active_tab == 'dct_welcome_tab' ? ' ui-tabs-active ui-state-active' : '';?>" >
           		...
           		<a href="?page=dct-options&tab=dct_welcome_tab" class="ui-tabs-anchor" > Welcome
           ...
           <a href="themes.php?page=pt-one-click-demo-import" class="ui-tabs-anchor" >Import Demo Data
           ...
           <a href="?page=dct-options&tab=dct_changeslogs_tab" class="ui-tabs-anchor"  >Changes Logs
           ...
           <a href="?page=dct-options&tab=dct_support_tab" class="ui-tabs-anchor"  >Support
           ...
           <a href="?page=et_divi_options#wrap-dct"  class="ui-tabs-anchor" >Theme Options
           ...
           <li class="ui-state-default ui-corner-top <?php echo $active_tab == 'dct_systemstatus_tab' ? ' ui-tabs-active ui-state-active' : '';?>" >

           <a href="?page=dct-options&tab=dct_systemstatus_tab" class="ui-tabs-anchor" >System Status
